...
include'koneksi.php';
$sql = "SELECT * FROM tamuu WHERE id_tamu='$id_tamu'";
...
<form action="?url=proses-edit-buku&id_tamu=<?= $id_tamu; ?>" method="post">
    ...
    <div class="form-group mb-2">
        <label>Asal</label>
        <input value="<?= $data['alamat'] ?>" type="text" name="asal_tamu" class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>Pekerjaan</label>
        <input value="<?= $data['profesi'] ?>" type="text" name="pekerjaan" class="form-control" required>
    </div>
    <div class="form-group mb-2">
